...
const api = {
  ...
  confirmWorkflow: (request: ConfirmWorkflowRequest): Promise<WorkflowOperationResult> => ipcRenderer.invoke("workflow:confirm", request),
  reviewWorkflow: (request: ReviewWorkflowRequest): Promise<AppSnapshot> => ipcRenderer.invoke("workflow:review", request),
