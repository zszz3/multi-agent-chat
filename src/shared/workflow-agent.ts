...
export function buildWorkflowAgentPrompt({ objective }: WorkflowAgentPromptInput): string {
  ...
  return [
    ...
    "",
    "Interview the user and create an executable WorkflowV2Definition through the MCP workflow_create tool.",
    "",
    ...
    "- Do not send a definition as ordinary prose. Call workflow_create with title, objective, and definition.",
