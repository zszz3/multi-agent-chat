...
export const hermesSurfaceSupport: RuntimeSurfaceSupport[] = [
...
export const hermesInteractiveSessionCapabilities: ChatRuntimeSessionState["capabilities"] = {
...
export function getHermesCapabilities(runtime: AgentRuntime): RuntimeCapabilities {
  return {
