...
- Phase 02: in progress; executable discovery, Main composition, shared process-tree strategies, production Runtime lifecycle injection, local-file containment, and managed skill-link ownership are implemented, while compatibility cleanup and Windows integration evidence are pending.
