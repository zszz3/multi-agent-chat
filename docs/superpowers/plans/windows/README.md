...
- Phase 02: in progress; executable discovery, Main composition, shared process-tree strategies, production Runtime lifecycle injection, and local-file containment hardening are implemented, while compatibility cleanup, junction work, and Windows integration evidence are pending.
