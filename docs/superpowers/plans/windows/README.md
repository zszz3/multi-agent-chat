...
- Phase 02: in progress; executable discovery, Main composition, and shared process-tree strategies are implemented, while Runtime lifecycle migration, path hardening, junction work, and Windows integration evidence are pending.
