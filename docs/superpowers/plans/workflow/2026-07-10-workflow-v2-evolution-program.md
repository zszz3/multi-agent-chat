...
**Required contract:** [Workflow V2 Evolution Program Contract](../../specs/workflow/2026-07-10-workflow-v2-evolution-program.md)
...
- [ ] Every ID in `docs/workflow-v2/evolution-requirement-matrix.md` has direct positive and failure/fault evidence.
