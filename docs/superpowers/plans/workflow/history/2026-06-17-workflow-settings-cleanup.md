...
**Authoritative design:** [Workflow Settings Cleanup Design](../../../specs/workflow/history/2026-06-17-workflow-settings-cleanup-design.md)
...
For current Workflow V2 behavior, use the [Foundation specs](../../../specs/workflow/foundation/README.md). For implementation traceability, use the [Foundation plans](../foundation/README.md).
