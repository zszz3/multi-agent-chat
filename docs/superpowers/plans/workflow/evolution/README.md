# Workflow V2 Evolution Plans

状态：Proposed；未实现。严格按顺序执行：

1. [Evolution Program Plan](2026-07-10-workflow-v2-evolution-program.md)
...
权威行为：[Evolution specs](../../../specs/workflow/evolution/README.md)。每个未勾选项都代表尚未完成的真实工作。
