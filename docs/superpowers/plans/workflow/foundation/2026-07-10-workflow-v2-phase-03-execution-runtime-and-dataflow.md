...
```bash
git diff --stat
git diff -- docs/superpowers/specs/workflow/foundation/2026-07-10-workflow-v2-phase-03-execution-runtime-and-dataflow.md src/shared/workflow-v2 src/main/workflows/v2 src/main/workflows/workflow-runtime.ts
```
...
```bash
git add docs/superpowers/plans/workflow/foundation/2026-07-10-workflow-v2-phase-03-execution-runtime-and-dataflow.md
