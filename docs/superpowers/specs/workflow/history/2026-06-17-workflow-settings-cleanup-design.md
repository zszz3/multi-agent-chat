...
This is a renderer UI cleanup design, not a Workflow V2 execution contract. The authoritative Workflow V2 architecture starts at the [Foundation implementation program](../foundation/2026-07-10-workflow-v2-implementation-program.md).
