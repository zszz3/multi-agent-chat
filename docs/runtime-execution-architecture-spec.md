# Runtime Execution Architecture Spec

This entry document now points to the 2026-07-08 runtime boundary reset contract.
...
Use the master contract plus the relevant phase spec as the source of truth for runtime-execution work.
